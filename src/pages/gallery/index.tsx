  ...
  return (
    <div>
      <HeroSectionPage
        ...
        name="gallery"
        desc="Welcome to our gallery page! Explore our collection of photos showcasing the events, fun and adventure waiting for you at our recreational club. Join us for your next memorable experience!"
      />

      <div className="mt-10">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 shadow-xl rounded-t-lg p-4">
          {[...billiards.images].map((image) => (
